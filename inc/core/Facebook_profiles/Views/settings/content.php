<div class="card card-flush m-b-25">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-solid" id="facebook_app_version" name="facebook_app_version" value="<?php _e( get_option("facebook_app_version", "v18.0") )?>">
        </div>
...
<div class="card card-flush m-b-25">
    ...
    <div class="card-body">
    	...
    	<div class="mb-4">
            <label for="facebook_profile_official_status" class="form-label"><?php _ec("Facebook Profile API Official")?></label>
            <div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="facebook_profile_official_status" id="facebook_profile_official_status_disable" <?php _e( get_option('facebook_profile_official_status', 0)  == 0?"checked":"" )?> value="0">
                    <label class="form-check-label" for="facebook_profile_official_status_disable"><?php _e("Disable")?></label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="facebook_profile_official_status" id="facebook_profile_official_status_enable" <?php _e( get_option('facebook_profile_official_status', 0)  == 1?"checked":"" )?> value="1">
                    <label class="form-check-label" for="facebook_profile_status_enable"><?php _e("Enable")?></label>
                </div>
            </div>
        </div>
        <div class="mb-4">
            <label for="facebook_profile_cookie_status" class="form-label"><?php _ec("Facebook Profile Cookies API")?></label>
            <div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="facebook_profile_cookie_status" id="facebook_profile_cookie_status_disable" <?php _e( get_option('facebook_profile_cookie_status', 1)  == 0?"checked":"" )?> value="0">
                    <label class="form-check-label" for="facebook_profile_cookie_status_disable"><?php _e("Disable")?></label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="facebook_profile_cookie_status" id="facebook_profile_cookie_status_enable" <?php _e( get_option('facebook_profile_cookie_status', 1)  == 1?"checked":"" )?> value="1">
                    <label class="form-check-label" for="facebook_profile_status_enable"><?php _e("Enable")?></label>
                </div>
            </div>
        </div>
